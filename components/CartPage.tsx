...
// (Keep FeaturedItem interface and featuredItems array for mock recommendations)
...
export default function CartPage(): JSX.Element | null {
              ...
              <div key={item.id} className="cartItem">
                ...
                <div className="itemDetails">
                  ...
                  <div className="itemActions">
                    ...
                    <button onClick={() => removeFromCart(item.id)} className="text-[#007185] hover:underline cursor-pointer bg-transparent border-none p-0">Delete</button>
                ...
                <div className="itemPrice">
                  ...
                  {item.mrp > 0 && <span className="mrp">M.R.P: ₹{item.mrp.toFixed(2)}</span>}
                </div>
              </div>
            ))
          )}
